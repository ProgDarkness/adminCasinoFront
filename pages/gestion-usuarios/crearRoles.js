...
function CrearRoles({ visibled, setVisibled, tokenQuery, permisos }) {
  ...
  const header = (
    <motion.div
      ...
      className="bg-[#006993d3] text-white w-60 redondeo-xl"
    >
      <h1>CREAR ROLES</h1>
    </motion.div>
  )
  ...
  const accionEliminarRol = (rowData) => {
    return (
      <div>
        {permisos?.tx_permisos[3] && rowData.code !== 1 && (
          <Button
        ...
        {permisos?.tx_permisos[2] && rowData.code !== 1 && (
          <Button
            onClick={() => editRol(rowData)}
            className="p-button-warning p-button-rounded p-button-sm ml-1"
            tooltip="Editar"
          >
            ...
            <>
              ...
              >
                <div
                  ...
                  className="bg-[#006993d3] text-white w-40 redondeo-xl"
                >
                  <h1>DATOS DEL ROL</h1>
                </div>
              </motion.center>
              <div className="field">
                <span className="p-float-label">
                  <InputText
                    ...
                    className="redondeo-lg w-[105%] p-inputtext-sm"
                  />
                  <label htmlFor="nombreRol">Nombre</label>
                </span>
              ...
              <div className="field">
                <span className="p-float-label">
                  <Dropdown
                    ...
                    optionLabel="name"
                  />
                  <label htmlFor="ruta">Módulos</label>
                </span>
              ...
              <div className="field">
                <span className="p-float-label">
                  <MultiSelect
                    ...
                    id="permiso"
                    className="redondeo-lg w-[105%] h-[2.75rem] p-inputtext-sm"
                    onChange={(e) => setSelectedPermisos(e.value)}
                  />
                  <label htmlFor="permiso">Permisos</label>
                </span>
              ...
              <Button
                label="Crear"
                className="p-button-raised p-button-success redondeo-lg p-button-sm"
                disabled={
                  nameRol?.length < 1 ||
                  nameRol === null ||
                  selectedRuta === null ||
